...
/** ChartAutoAnalysis POST /api/chart/analysis */
export async function chartAutoAnalysisUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.ChartAutoAnalysisUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBIResponse_>('/api/chart/analysis', {
    method: 'POST',
    params: {
      ...params,
    },
